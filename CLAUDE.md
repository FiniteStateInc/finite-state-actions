...
| `download-sbom` | Export CycloneDX/SPDX SBOM via `fs-cli export`, upload as artifact; takes `api-token`/`domain`/`project-name` when no setup ran                                                  |
